...
posts.forEach((element,index) => {
    divContainer.innerHTML += generatePost (element.author.image, element.author.name, element.created, element.content, element.media, element.likes, index)
...
function generatePost(imgSrc,name,dateGenerate,content,media,likes,index){
    return ` 
    <div class="post">
